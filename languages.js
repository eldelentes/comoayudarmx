var languagesModule = (function() {
	...
	var languageDefinitions = {
		...
		en: {
			...
			card_intro2: "Here is a list of different organizations, collection centers, or different ways in which you can help the rescuers and those affected by the earthquakes.",
			...
			modal2_formtext: " Send help information",
			...
			volunteer_allcaps: "¡ZONES WHERE HELP IS MOST NEEDED MARKED IN RED!",
			...
			volunteer_form1: "Publish Help Options",
			volunteer_form2: "Send the information of your help options with vital information such as: Who can be helped, where can you help from\n and kind of help is needed, from the next points of contact:",
		},
	};
